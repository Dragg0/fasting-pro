...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="bg-[#05070b] text-[#f4f7fb] min-h-screen font-sans selection:bg-cyan-500/30 overflow-x-hidden antialiased" style={{ backgroundColor: '#05070b', color: '#f4f7fb' }}>
